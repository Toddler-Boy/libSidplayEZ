...
{ "Jeroen Tel",							{	.folder = "/MUSICIANS/T/Tel_Jeroen/",				.fltCox = 0.3,	.fltGain = 0.9,	.digi = 0.8 } },
...
{ "Mark Cooksey",						{	.folder = "/MUSICIANS/C/Cooksey_Mark/",				.fltCox = 0.2,	.flt0Dac = 0.3,	.digi = 1.1	} },
...
{ "Richard Joseph",						{	.folder = "/MUSICIANS/J/Joseph_Richard/",			.fltCox = 0.4,	.fltGain = 1.0	} },
